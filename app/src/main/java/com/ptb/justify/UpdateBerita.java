...
public class UpdateBerita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(UpdateBerita.this, "No Image Selected",Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        if (bundle != null){
            Glide.with(UpdateBerita.this).load(bundle.getString("Image")).into(updateImage);
    ...
    public void saveData(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(UpdateBerita.this);
        ...
        databaseReference.setValue(beritaClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    reference.delete();
                    Toast.makeText(UpdateBerita.this,"Updated",Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UpdateBerita.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}